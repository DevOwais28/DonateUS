      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="hidden sm:ml-6 sm:flex sm:items-center space-x-3">
            {token ? (
              <>
                <Link to={role === 'admin' ? '/admin' : '/dashboard'} className="flex items-center gap-2 rounded-lg px-4 py-2 text-sm font-medium text-slate-300 hover:bg-white/10 hover:text-white transition-all duration-200">
                  {user?.picture ? (
                    <img
                      src={user.picture}
                      alt={user.name}
                ...
                <button
                  onClick={() => clearUser()}
                  className="rounded-lg px-4 py-2 text-sm font-medium text-slate-300 hover:bg-red-500/10 hover:text-red-300 transition-all duration-200"
                >
                  Logout
                </button>
              </>
